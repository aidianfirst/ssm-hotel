...
<div class="layui-container shopdata">
    <div class="layui-card shopdata-intro">
        ...
        <div class="layui-card-header">
				<span class="layui-breadcrumb layui-hide-xs" style="visibility: visible;">
                    ...
                    <a><cite>酒店${room.floorName}</cite></a>
                    <span lay-separator="">/</span>
                    <a><cite>房间详情</cite></a>
                </span>
        </div>
        ...
        <div class="layui-card-body layui-row">
            <div class="layui-col-md6">
                <div class="intro-img photos">
                    <img id="coverImg" src="/hotel/show/${room.photo}" alt="产品封面" layer-index="0">
                </div>
            </div>
            <div class="layui-col-md6">
                <div class="intro-txt">
    ...
    <div class="layui-card shopdata-content">
        <div class="layui-card-body detail-body layui-text">
            ...
            <div id="roomContent">${room.roomDesc}</div>
        </div>
    </div>
</div>
    ...
    <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="book_date" lay-verify="required" autocomplete="off" readonly placeholder="请选择预订日期范围" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="arriveDate" id="arriveDate" lay-verify="required"  readonly placeholder="请选择入住时间" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="leaveDate" id="leaveDate" lay-verify="required" readonly  placeholder="请选择离店时间" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="day" id="day" lay-verify="required" readonly  placeholder="入住天数自动计算" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="reservePrice" id="reservePrice" lay-verify="required"  readonly placeholder="房费价格自动计算" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="reservationName" lay-verify="required"  placeholder="请输入预订人姓名" class="layui-input">
                </div>
            </div>
    ...
    layui.use(["form","element","carousel","layer","laydate"], function () {
        ...
        laydate.render({
            ...
            range:"至",//选择范围，内容可以自定义
                ...
                var startDate = value.substr(0,value.indexOf(" ")).trim();//入住日期
                var endDate = value.substr(value.lastIndexOf(" "),value.length).trim();//离店日期
                //赋值

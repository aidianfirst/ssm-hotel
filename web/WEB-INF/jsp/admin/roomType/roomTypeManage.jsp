                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="roomTypeName" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer','upload'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'availableNum', minWidth: 100, title: '可预定数', align: "center"},
                {field: 'reservedNum', minWidth: 100, title: '已预订数', align: "center"},
                {field: 'livedNum', minWidth: 100, title: '已入住数', align: "center"},
                {field: 'status', minWidth: 100, title: '状态', align: "center",templet:function (s) {
                        return s.status == 1 ? "可预订" : "<font color='#ff1493'>房型已满</font>"
                    }},
